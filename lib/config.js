...
export const SHOPIFY_SCOPES = process.env.SHOPIFY_SCOPES || "read_products,write_products,read_script_tags,write_script_tags,read_themes,write_themes";
export const HOST = "https://preorder-app-nu.vercel.app";
